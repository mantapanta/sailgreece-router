...
| Haltegrund | schlamm-seegras |
| Haltequalität | mittel — Schlamm mit Seegras durchsetzt — Kette lang stecken, um das Seegras zu durchdringen. |
| Seegras | Seegras im gesamten Hafengrund. |
| Kapazität | 80 Yachten |
| Reservierbar | ja — Telefonisch über die Hafenbehörde Lavrion |
| Müllentsorgung | Zentrale Container am Kai |
| Landstrom / Wasser | ja / ja |
| Diesel am Steg | ja |
| Duschen / WC | ja |
| Versorgung an Land | Supermarkt, 3 Minuten Gehweite |
| Preis | ca. 15–25 EUR/Nacht (2024, Hafendienst Lavrion) |
| Hafengebühren | Limenarchio Lavrion |
| Schwell | Geschützt bei Meltemi, Schwell bei starkem Südwind. |
| Fährverkehr | Große Fähren legen am Nordkai an. |
| Beiboot-Anlandung | — |
| Auflagen | Gewerbekai für Frachter freihalten |
| UKW-Kanal | 12 |
...
| Haltequalität | gut — Sandgrund hält gut; Kettenlänge wegen der Fallböen reichlich bemessen. |
| Seegras | Dunkle Seegrasflecken zwischen den Sandflächen. |
...
| Diesel am Steg | nein |
| Duschen / WC | nein |
| Versorgung an Land | Taverne, 3 Minuten am Strand |
| Preis | kostenfrei |
| Hafengebühren | keine |
| Schwell | Guter Windschutz bei Nord, aber die Fallböen treffen das Deck. |
| Fährverkehr | Passierende Fähren auf dem Weg nach Lavrion erzeugen leichten Schwell. |
| Beiboot-Anlandung | Anlandung am Strand vor den Tavernen |
| Auflagen | Ausgewiesene Schwimmbereiche beachten |
| UKW-Kanal | — |
...
| Anlegeart | murings |
| Wassertiefe | 3–8 m |
| Grössenlimit (LoA) | 60 m |
| Haltegrund | schlamm |
| Haltequalität | gut — Muringleinen vorhanden, eigener Anker nicht nötig. |
| Seegras | — |
| Kapazität | 670 Yachten |
| Reservierbar | ja — D-Marin App oder Telefon (Nummer aus Lauf 1 unverifiziert) |
| Müllentsorgung | Vollständige Entsorgungseinrichtungen |
| Landstrom / Wasser | ja / ja |
| Diesel am Steg | ja |
| Duschen / WC | ja |
| Versorgung an Land | Supermarkt, 2 Minuten Gehdistanz |
| Preis | ca. 90–140 EUR/Nacht für 12–15 m (2024, D-Marin) |
| Hafengebühren | In der Marinagebühr enthalten |
| Schwell | Schutz gegen sämtliche Windrichtungen. |
| Fährverkehr | Keine Fähren im Yachthafen. |
| Beiboot-Anlandung | — |
| Auflagen | Ankerverbot |
| UKW-Kanal | 9 |

Quellen: Deep-Research Lauf 1: D-Marin Zea Official Guide 2024
