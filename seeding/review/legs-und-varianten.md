...
Quelle: Brief-Addendum 2026-07-30 (Quelle 1: Etappenplan Plan A/B, Rückfallhäfen-Kette, Distanzen; Quelle 2: Düsenzonen). Distanzen ab Basis auf Alimos rebasiert (Quell-Etappenplan war Lavrion-basiert). Vor Freigabe prüfen. | FR9-Rundrouten ergänzt (2026-08-03): neue Etappen-Distanzen aus dem Feldtest-Addendum 2026-08-02 übernommen; bereits importierte Etappen behalten ihre getesteten Werte (Konflikt kythnos--serifos: 17 sm importiert schlägt 31 sm Notiz); milos--polyaigos geometrisch berechnet und als solches markiert.

## Etappen (30)

| Etappe | Distanz | Wegpunkte | Warnungen | Rebasing |
|---|---|---|---|---|
| `athen--attika` | 22 sm | 0 | Düse Kea-Kanal (Lavrion–Makronisos): Modellwerte glätten die Beschleunigung | — |
| `athen--kea` | 36 sm | 3 | Düse Kea-Kanal (Lavrion–Makronisos): Modellwerte glätten die Beschleunigung | ursprünglich lavrion-basiert |
| `attika--kea` | 15 sm | 0 | Düse Kea-Kanal (Lavrion–Makronisos): Modellwerte glätten die Beschleunigung | — |
| `folegandros--milos` | 34 sm | 0 | Langer offener Schlag (34 sm), keine Zwischenoption | — |
| `ios--santorin` | 21 sm | 0 | — | — |
| `kea--athen` | 36 sm | 3 | Düse Kea-Kanal (Lavrion–Makronisos): Modellwerte glätten die Beschleunigung | ursprünglich lavrion-basiert |
| `kea--kythnos` | 18 sm | 3 | — | — |
| `kea--syros` | 34 sm | 0 | Kafireas-/Andros-Sektor: Beschleunigung, Modellwerte zu niedrig | — |
| `kythnos--athen` | 48 sm | 0 | Düse Kea-Kanal auf dem letzten Schlag; langer Törn (48 sm) | — |
| `kythnos--kea` | 18 sm | 3 | — | — |
| `kythnos--serifos` | 17 sm | 3 | — | — |
| `milos--polyaigos` | 8.1 sm | 0 | Distanz 8.1 sm GEOMETRISCH aus Koordinaten berechnet (keine Quellenangabe im Addendum) — Luftlinie unterschätzt den Seeweg, vor dem Törn verifizieren | — |
| `milos--sifnos` | 24 sm | 0 | — | — |
| `mykonos--paros` | 20 sm | 0 | Düse Mykonos–Paros: deutlich mehr Wind als der Modellwert | — |
| `naxos--amorgos` | 31 sm | 3 | Nur mit vorgedachtem Fähr-Exit über Naxos (Eskalationsleiter Quelle 1) | — |
| `naxos--paros` | 12 sm | 3 | Düse Paros–Naxos: deutlich mehr Wind als der Modellwert | — |
| `naxos--santorin` | 51 sm | 4 | Langer Schlag, nur bei stabilem Fenster (Quelle 1: 8h30 / 6h50) | — |
| `paros--ios` | 32 sm | 0 | — | — |
| `paros--naxos` | 12 sm | 3 | Düse Paros–Naxos: deutlich mehr Wind als der Modellwert | — |
| `paros--sifnos` | 26 sm | 2 | Insel-Beschleunigungszonen zwischen Sifnos und Paros | — |
| `paros--syros` | 24 sm | 0 | — | — |
| `polyaigos--paros` | 33 sm | 0 | — | — |
| `santorin--folegandros` | 25 sm | 0 | Offener Schlag westwärts, kein Schutz unterwegs | — |
| `serifos--kythnos` | 17 sm | 3 | — | — |
| `serifos--sifnos` | 13 sm | 2 | — | — |
| `sifnos--milos` | 24 sm | 0 | — | — |
| `sifnos--paros` | 26 sm | 2 | Insel-Beschleunigungszonen zwischen Sifnos und Paros | — |
| `sifnos--serifos` | 13 sm | 2 | — | — |
| `syros--kythnos` | 27 sm | 0 | — | — |
