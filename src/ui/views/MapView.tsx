          ...
          {MAPS_ENV.ok ? (
            <APIProvider apiKey={MAPS_ENV.env.apiKey}>
              ...
              <div className="layer-chips">
                ...
                {/* Nur wenn es überhaupt eine Kite-Bibliothek gibt: ein Chip für
                    eine leere Ebene wäre eine Zusage, die die Karte nicht hält.
                    Der Chip nennt gleich die Zahl der heute passenden Spots —
                    das ist die Antwort, für die man ihn antippt. */}
