...
- source_spec: `_bmad-output/implementation-artifacts/spec-round-trip-umbau.md`
  status: ERLEDIGT (2026-08-03, Commit a449581) — 14 Legs aus 31 Vorkommen, verlustfrei per Skript verifiziert; saronische-alternative samt ihrer 3 Legs gestrichen; legs-Collection im Import; BREAKING-Ausweis in der Review-Sicht. NACHGEZOGEN (2026-08-03, Commit 9b31713): FR9-Rundrouten angelegt — 16 neue Etappen, Westkykladen 11 + Ostkykladen 12 Etappen, Ketten lückenlos geprüft. Distanzkonflikt entschieden: importierte (getestete) Werte gewinnen, kythnos--serifos bleibt 17 sm statt 31 sm aus der Notiz. M3-Kettenbruch geschlossen via milos--polyaigos (8,1 sm GEOMETRISCH berechnet — einzige Etappe ohne Quelle, im Leg als Warnung markiert, vor dem Törn verifizieren).
