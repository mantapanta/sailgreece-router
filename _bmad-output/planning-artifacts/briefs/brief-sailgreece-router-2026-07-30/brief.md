...
- **Best-Practice-Platzbibliothek:** dieselbe Kuratierung für Buchten, Ankerplätze und Häfen — jeder Platz mit seinen Qualitäten (Schönheit, Restaurant, Badestrand) und einem **Schutzprofil**: bei welcher Wind- und Wellenrichtung/-stärke liegt man dort nachts geschützt. Das Profil ist direkt kuratierbar, denn Heikell und CruisersWiki nennen die geschützten Windrichtungen je Bucht explizit (z. B. „geschützt bei N bis O"); dazu gilt die universelle Regel **Lee ist immer geschützt, Luv nie**. Zusammen ergibt das eine deterministische **Rot/Gelb/Grün-Ampel pro Platz und Hauptwindrichtung** — die Tagesplanung mappt den Wind- und Wellen-Forecast darauf und zeigt, welche Zielorte entlang der Route grün sind.
